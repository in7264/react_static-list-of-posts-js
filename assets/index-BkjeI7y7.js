...
expedita consequatur consequatur dolores quia eos et placeat`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],im=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({comment:e})=>T.jsxs("div",{className:"CommentInfo",children:[T.jsxs("div",{className:"CommentInfo__title",children:[T.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",T.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),T.jsx("div",{className:"CommentInfo__body",children:e.body}),e.post&&T.jsxs("div",{className:"CommentInfo__post",children:["Related to post: ",e.post.title]})]}),Lc=({comments:e})=>T.jsx("div",{className:"CommentList",children:e.map(t=>T.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>T.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>e?T.jsxs("div",{className:"PostInfo",children:[T.jsxs("div",{className:"PostInfo__header",children:[T.jsx("h3",{className:"PostInfo__title",children:e.title}),T.jsxs("p",{children:[" Posted by ",e.user?T.jsx(Tc,{user:e.user}):"Unknown user"]})]}),T.jsx("p",{className:"PostInfo__body",children:e.body}),e.comments.length===0?T.jsxs(T.Fragment,{children:[T.jsx("hr",{}),T.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]}):T.jsx(Lc,{comments:e.comments})]}):null,Rc=({posts:e})=>T.jsx("div",{className:"PostList",children:e.map(t=>T.jsx(Mc,{post:t},t.id))}),Dc=()=>tm.map(e=>({...e,user:Nc.find(t=>t.id===e.userId)||null,comments:im.filter(t=>t.postId===e.id)})),jc=()=>im.map(e=>({...e,post:tm.find(t=>t.id===e.postId)||null})),Oc=()=>{const e=Dc(),t=jc();return T.jsxs("section",{className:"App",children:[T.jsx("h1",{className:"App__title",children:"Static list of posts"}),T.jsx(Rc,{posts:e,comments:t})]})};em(document.getElementById("root")).render(T.jsx(Oc,{}));
